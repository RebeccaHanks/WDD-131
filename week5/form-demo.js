...
function validateForm(event) {
  ...
  function togglePaymentDetails(e) {
    ...
    theForm.nextElementSibling.credit.required = false;
    theForm.nextElementSibling.paypal.required = false;
  ...
  // watch for a change event
document.querySelector("#payment-method").addEventListener("change", togglePaymentDetails)
